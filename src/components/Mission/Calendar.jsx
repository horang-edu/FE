...
function Calendar() {
    return (
            <div class='mission-layout w-417 flex flex-row bg-color2 items-center relative'>
                <img class='absolute top-0 bottom-0 left-1/3 transform -translate-x-1/8 w-1/4 h-auto' src={Stamp} alt="stamp"
                 />
                <div class='flex flex-col ml-25 mt-17 mb-17 justify-start relative'>
                    <div class='font-semibold text-color6 text-24 '>9월</div>
                    <div class='font-semibold text-22 mb-26 '>매일 출석체크</div>
