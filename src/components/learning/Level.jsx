    ...
    return (
        <div className="mt-48">
            ...
            <div class='list-container'>
                <div class='list'>
                    <div>
                        <div className='mt-31 ml-43 text-20 tracking-0.5'>0과 1로 이루어진 세상</div>
                    ...
                    <img className="w-50 h-50 mr-43 flex mt-55" src={play}></img>
                </div>

                <div class='list'>
                    <div>
                        <div className='mt-31 ml-43 text-20 tracking-0.5'>프로그래밍이란?</div>
                        <div className='mt-19 ml-43 text-16 tracking-0.5 text-text3'>
                            컴퓨터와 대화하는 방법이 뭘까?<br />
                ...
                <div class='list'>
                    <div>
                        <div className='mt-31 ml-43 text-20 tracking-0.5'>왜 배워야 할까요?</div>
                        <div className='mt-19 ml-43 text-16 tracking-0.5 text-text3'>
